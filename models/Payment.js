...
const Payment = sequelize.define('Payment', {
  ...
  paymentMethod: {
    type: DataTypes.ENUM('credit_card', 'bank_transfer', 'check', 'cash', 'money_order', 'online'),
    allowNull: false
  },
  transactionId: {
    type: DataTypes.STRING,
    allowNull: true,
    comment: 'External payment processor transaction ID (e.g., Stripe)'
  },
  checkNumber: {
    type: DataTypes.STRING,
    allowNull: true
  ...
  netAmount: {
    ...
    get() {
      return parseFloat(this.amount || 0) - parseFloat(this.processingFee || 0);
    }
  },
  description: {
    type: DataTypes.STRING,
...
// Static method to get payment history for an invoice
